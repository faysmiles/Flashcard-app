...
_TOPIC_EMOJI_MAP = {
    ...
    'ireland': '🍀', 'britain': '🏴', 'england': '🏴', 'scotland': '🏴󠁧󠁢󠁳󠁣󠁴󠁿',
    'wales': '🏴󠁧󠁢󠁷󠁬󠁳󠁿', 'france': '🗼', 'germany': '🌍', 'italy': '🍕',
    ...
    'harry potter': '🧙', 'hogwarts': '🧙', 'wizarding': '🧙',
    'potter': '🧙',
    'jedi': '⚔️', 'lightsaber': '⚔️',
    'lord of the rings': '💍', 'hobbit': '💍', 'tolkien': '📖',
    'marvel': '🦸', 'avengers': '🦸', 'spider-man': '🕷️', 'batman': '🦇',
    'disney': '✨', 'pixar': '🎬', 'dreamworks': '🎬',
    'frozen': '❄️', 'lion king': '🦁', 'finding nemo': '🐠',
    'toy story': '🧸', 'shrek': '🌿',
    'netflix': '📺', 'stranger things': '📺', 'game of thrones': '⚔️',
