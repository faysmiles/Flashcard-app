...
_TOPIC_EMOJI_MAP = {
    ...
    'labrador': '🐕', 'retriever': '🐕', 'terrier': '🐕', 'poodle': '🐕',
    'bulldog': '🐕', 'husky': '🐕', 'spaniel': '🐕', 'dachshund': '🐕',
    ...
    'penguin': '🐧', 'penguins': '🐧',
    'flamingo': '🦩', 'flamingos': '🦩',
    'duck': '🦆', 'ducks': '🦆', 'swan': '🦢', 'swans': '🦢',
    'robin': '🐦', 'sparrow': '🐦', 'finch': '🐦', 'pigeon': '🐦',
    'crow': '🐦', 'raven': '🐦', 'magpie': '🐦',
    'peacock': '🦚', 'peacocks': '🦚',
    'turkey': '🦃', 'turkeys': '🦃', 'chicken': '🐔', 'chickens': '🐔', 'hen': '🐔',
    ...
    # --- Reptiles ---
    'snake': '🐍', 'snakes': '🐍', 'serpent': '🐍', 'viper': '🐍', 'cobra': '🐍',
    'lizard': '🦎', 'lizards': '🦎', 'gecko': '🦎', 'iguana': '🦎', 'chameleon': '🦎',
    'crocodile': '🐊', 'crocodiles': '🐊', 'alligator': '🐊', 'alligators': '🐊',
    'turtle': '🐢', 'turtles': '🐢', 'tortoise': '🐢', 'tortoises': '🐢',
    'dinosaur': '🦕', 'dinosaurs': '🦕', 'trex': '🦖', 't-rex': '🦖',
    'pterodactyl': '🦕', 'fossil': '🦕', 'fossils': '🦕', 'prehistoric': '🦕',
    ...
    'goat': '🐐', 'goats': '🐐', 'kid': '🐐',
    'donkey': '🫏', 'donkeys': '🫏', 'mule': '🫏', 'ass': '🫏',
    'llama': '🦙', 'llamas': '🦙', 'alpaca': '🦙', 'alpacas': '🦙',
    'camel': '🐪', 'camels': '🐪', 'dromedary': '🐪',
    ...
    'revolution': '⚔️', 'revolutions': '⚔️', 'empire': '👑', 'king': '👑', 'queen': '👑',
    ...
    'robot': '🤖', 'robots': '🤖', 'artificial intelligence': '🤖', 'ai': '🤖',
    ...
    'architecture': '🏛️', 'building': '🏗️', 'design': '✏️',
    'fashion': '👗', 'clothing': '👗', 'textile': '🧵',
    'photography': '📷', 'cinema': '🎬', 'movie': '🎬', 'film': '🎬',

    # --- Education & learning ---
    'school': '🎓', 'education': '🎓', 'learning': '🎓', 'study': '📚',
    'university': '🎓', 'college': '🎓', 'teacher': '👩‍🏫', 'student': '🎓',
    'maths': '🔢', 'mathematics': '🔢', 'algebra': '🔢', 'geometry': '🔢',
    'physics': '⚛️', 'chemistry': '🧪', 'biology': '🔬',
    'geography': '🗺️', 'history': '📜', 'philosophy': '💭',
    'psychology': '🧠', 'sociology': '👥', 'economics': '💰',

    # --- Sport & exercise ---
    'football': '⚽', 'soccer': '⚽',
    'rugby': '🏉', 'cricket': '🏏', 'baseball': '⚾', 'softball': '⚾',
    'basketball': '🏀', 'netball': '🏀',
    'tennis': '🎾', 'badminton': '🏸', 'squash': '🎾',
    'swimming': '🏊', 'diving': '🤿',
    'athletics': '🏃', 'running': '🏃', 'cycling': '🚴', 'triathlon': '🏊',
    'golf': '⛳', 'gymnastics': '🤸', 'boxing': '🥊', 'martial arts': '🥋',
...
_FACT_EMOJI_PATTERNS = [
    ...
    (["die", "dying", "death", "deaths", "dead", "extinct", "extinction",
       "kill", "killed", "perish", "perishing", "end", "ending", "loss", "lost"], "💀"),
    ...
    (["big", "bigger", "biggest", "large", "larger", "largest", "huge", "giant",
       "enormous", "massive", "immense", "colossal", "gigantic", "great",
    ...
    (["old", "older", "oldest", "ancient", "history", "historical", "past",
       "ago", "century", "centuries", "millennium", "millennia", "prehistoric",
    ...
    (["year", "years", "century", "centuries", "decade", "decades",
    ...
    (["last", "final", "end", "ending", "finish", "finishing", "conclude",
       "conclusion", "complete", "completion", "ultimate"], "🏁"),
    (["change", "changed", "changing", "shift", "shifted", "transform",
       "transformed", "progress", "progressed", "develop",
